...
**The dangerous permit is the one that reads like a municipal permit.** A Kingdom permit cannot authorise food service (the local director of health issues that — Conn. Gen. Stat. §§ 19a-36g, 19a-36i, and a stall operating for no more than fourteen consecutive days in conjunction with a single event is a *temporary food establishment* under the definitions in § 19a-36g, needing its own permit from that director), the sale or service of alcohol (Liquor Control Act, Conn. Gen. Stat. § 30-1 et seq.), assembly occupancy above the certified load (State Fire Safety Code, Conn. Gen. Stat. § 29-291 et seq.), building or alteration work (§ 29-263), a street closure, or amplified sound controlled by ordinance. Paper suggesting otherwise exposes the holder to enforcement they believed they had been cleared for, and the Kingdom to their claim when it lands. Record which public licences the activity engages, and hold the holder's evidence of them before the permit commences.
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          help: "Anything sold or served for consumption needs the vendor's own permit from the local director of health; a stall running no more than fourteen consecutive days alongside a single event is a temporary food establishment under Conn. Gen. Stat. § 19a-36g.",
        },
        {
