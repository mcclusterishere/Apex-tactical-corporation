  ...
  fields: [
...

    {
      ...
      options: [
        ...
        { value: "CT_FOIA", label: "Connecticut Freedom of Information Act — Conn. Gen. Stat. § 1-200 et seq.", help: "Reaches any public agency. A denial of the right to inspect or copy must be made in writing within four business days, and a failure to comply within the applicable period is itself deemed a denial (§ 1-206(a)). Four is not the only interval in that section: where a request is determined to reach records subject to Conn. Gen. Stat. § 1-214(b) and (c) — an employee's personnel or medical file, which a request about a named officer's conduct frequently is — § 1-206(a) allows ten business days and the employee must be notified and may object. From a denial, actual or deemed, there are thirty days to file a free appeal with the Commission (§ 1-206(b)(1)). A letter that has announced a four-day deadline reads badly against a lawful ten-day one, so state the period subject to that section." },
