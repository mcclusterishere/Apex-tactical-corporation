...
**Not every use is an infringement, and triage must be honest.** Fair use (17 U.S.C. § 107) protects a great deal of commentary, criticism, parody, scholarship, and news reporting. Nominative fair use permits anyone to use the Kingdom's name and marks to refer to the Kingdom itself: a journalist, a scholar, a critic, or a former member may name it, describe it, and disagree with it in public without infringing anything. Reporting on the Kingdom is not trademark infringement. Criticism of the Kingdom is not copyright infringement. Neither is quotation, linking, or accurate description.
