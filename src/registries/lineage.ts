...
**Getting the records.** Most of this is a records-request exercise, so link each request; the principal federal holdings and their National Archives publication numbers sit against the record-set field below. One local point: Conn. Gen. Stat. § 7-51a opens birth records at least one hundred years old to any adult, and gives members of a genealogical society authorised in Connecticut full access to vital records held by a registrar, subject to stated exceptions. Joining one is the cheapest research decision available. Confirm the current text before relying on it.
...
**Classification and consent.** This register is SEALED and stays there. It holds data on living relatives who did not ask to be researched: kit numbers, matches' names, haplogroups, the family structure of people who are not members. Do not publish a living person's ancestry, name a match without written permission, or upload another person's results anywhere. Expect to find what nobody wanted — misattributed parentage, enslaved ancestors, enslaving ancestors, a line that simply ends. Record all of it; who gets told what is a decision for the family, not for the researcher.`,
  ...
  fields: [
    ...
    },
    {
      ...
      type: "textarea",
      section: "How they were classified",
      help: "What changed, when, in whose hand, and what else was happening in that office at that date. Where an administrative campaign is being relied on, name it and cite it — the Virginia Act to Preserve Racial Integrity of 1924, Plecker's December 1943 letter to local registrars and its enclosed list of surnames, a particular state's enumeration instructions, an agency's enrolment policy. Then check the timing honestly, because it is the first thing an opponent will check: a change dated before the policy it is attributed to needs a different explanation, and finding that yourself is much better than having it found. An unexplained change is a research question. A change tied to a documented policy, in the right order, is an argument.",
    },
    {
    ...
    // ------------------------------------------------------------- The sources
    {
      ...
      options: [
        ...
        { value: "DAWES", label: "Dawes Commission records, Five Tribes", help: "Record Groups 48 and 75. The Final Rolls are NARA T529, the enrolment cards M1186 (Enrollment Cards for the Five Civilized Tribes, 1898–1914), and the application jackets M1301 (Applications for Enrollment of the Commission to the Five Civilized Tribes, 1898–1914). Search every schedule, not only the by-blood ones — the Freedmen cards carry the fields naming the household that enslaved a person, and are frequently where a Black American family is actually found. The jacket holds the testimony and the Commission's reasoning; the roll entry holds a name and a number." },
        { value: "GUION_MILLER", label: "Eastern Cherokee applications (Guion Miller)", help: "NARA microfilm publication M685, Records Relating to Enrollment of Eastern Cherokee by Guion Miller, 1908–1910, including the roll, testimony of witnesses, and earlier census rolls used in the determinations. Read the outcome, not merely the application: in his report of 28 May 1909 Miller recorded 45,847 applications covering some 90,000 claimants, of whom 30,254 were enrolled. An ancestor who applied is an ancestor who applied, and the rejected files say so in terms. Record which it was." },
